...
- (Задание со *) настроен dynamic inventory для GCP для окружений stage и prod.
...
- (Задание со *) настроен dynamic inventory для GCP (gce.py).

#### Задание со * (слайд 66)

Dynamic inventory (gce.py) используется по-умолчанию (настроено в ansible.cfg).
